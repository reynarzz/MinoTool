...
namespace MinoTool
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        {
            return string.Format("RGBA({0}, {1}, {2}, {3})", r.ToString(format, CultureInfo.InvariantCulture.NumberFormat), g.ToString(format, CultureInfo.InvariantCulture.NumberFormat), b.ToString(format, CultureInfo.InvariantCulture.NumberFormat), a.ToString(format, CultureInfo.InvariantCulture.NumberFormat));
        }
